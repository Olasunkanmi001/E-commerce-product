  ...
  return (
    <div className='px-3 py-7 md:w[35%] lg:pt-36 '>
       ...
       <div className='flex justify-between bg-[#F7F8FD] h-14 rounded-2xl px-5 py-3 text-[#F1863B] text-2xl font-extrabold mt-6 md:w-40'>
        ...
        <div className='mt-3'>
            <button className='flex justify-center bg-[#F1863B] h-14 py-4 gap-3 font-bold w-[350px] rounded-2xl md:w-[200px] md:mt-3'> <BsCart2 className=' w-6 h-6'/> Add to cart</button>
        </div>
       </div>
